<p align="center">
  <img src="docs/screenshots/hero-260922174705.0.0.png" alt="Nuncid — point at a ticket and know what matters" width="100%">
</p>

<p align="center">
  <a href="https://github.com/markus-barta/nuncid/releases/latest"><img src="https://img.shields.io/badge/release-260922174705.0.0-0A84FF?style=flat-square" alt="Latest release 260922174705.0.0"></a>
...
<p align="center">
  <img src="docs/screenshots/workflow-260922174705.0.0.png" alt="Nuncid keeps the current ticket fixed between previous and next results" width="100%">
</p>
...
<p align="center">
  <img src="docs/screenshots/lookup-highlight-260922174705.0.0.png" alt="Three badge-free detection styles: gray dashes, dark-gray diagonal, and green fill" width="100%">
</p>
...
<p align="center">
  <img src="docs/screenshots/settings-markers-260922174705.0.0.png" alt="Detection frame colors, opacity, and independent diagonal strike-through settings" width="100%">
</p>
...
<p align="center">
  <img src="docs/screenshots/settings-showcase-260922174705.0.0.png" alt="Nuncid activation and spatial card appearance settings" width="100%">
</p>
...
<p align="center">
  <img src="docs/screenshots/inspection-zoom30-260922174705.0.0.png" alt="30% magnified content with a comfortably usable native-size header" width="28%">
  <img src="docs/screenshots/inspection-zoom300-260922174705.0.0.png" alt="300% content magnification constrained to the screen, with native scrolling" width="68%">
</p>

## Screen Recording setup

Without screen access, the inspection window shows three clear steps:

1. **Open System Settings** at Screen Recording.
2. **Drag Nuncid into the list**, then enable its switch. The small helper offers
   the running app directly, so there is no need to find it with the + button.
3. **Restart Nuncid** from the guide after allowing access.

The helper appears below or beside System Settings where space permits, with an
on-screen fallback for smaller displays. Its arrow gently pulses unless Reduce
Motion is enabled. The app remains paused until permission is available after
restart; settings and the installed app identity are preserved. A failed restart
preparation leaves the current app open with an explanation.

<p align="center">
  <img src="docs/screenshots/permission-guide-260922174705.0.0.png" alt="Three steps to enable Screen Recording: open settings, drag Nuncid, restart" width="65%">
  <img src="docs/screenshots/permission-helper-260922174705.0.0.png" alt="Compact Nuncid app drag source beside System Settings" width="33%">
</p>
...
<p align="center">
  <img src="docs/screenshots/version-history-260922174705.0.0.png" alt="Nuncid Version History with the current release highlighted and benefit-led notes" width="100%">
</p>
...
Issue labels use nearby text in the same window. A unique GitHub pull or workflow-run URL, or an explicit `--repo` on that number, covers every mention of that number in that window, including `gh pr view`, `checks`, `diff`, and `merge`. A nearby project name does not replace that URL, and another window never contributes a repository. Clipped
crop-edge identifiers and incomplete repository names are withheld until complete context is available. At most eight targeted context rereads per viewport refresh can recover a repository that sits outside the first discovery tile. Pictured commands are never executed.
...
<p align="center">
  <img src="docs/screenshots/workflow-run-260922174705.0.0.png" alt="GitHub workflow run summary with status, branch, commit, duration and link" width="70%">
</p>
...
- Explicit GitHub pull-request URLs route directly to their repository, and one unique URL covers the other mentions of that pull request in the same window.
...
It reads the saved INSPR presentation bundle pinned at
`2b8f9dbf160ea666d17d3f8c079712e5f31900b5`: the date uses an 80%
...
SemVer releases keep their original strings and plain presentation. Every build
verifies the complete offline bundle against committed digests. The native
adapter uses its opacity and tint data; web-only separators and JavaScript
interaction stay inactive. No version configuration is fetched at runtime.
...
The **Capture release visuals** workflow can perform capture on a GitHub Mac
runner, keeping test windows off your own displays. It runs on `release/**`
branches and can also be dispatched manually. Download its `release-visuals`
artifact into `docs/screenshots` and review those images before sealing a candidate.
